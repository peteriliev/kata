...
import main.java.dijkstra.Dijkstra30;
...
public class DijsktraTest {
	...
	public void t4() throws Exception {
		...
		final int[] paths = Dijkstra30.sssp(g, 0)[0];
		final int[] pred = Dijkstra30.sssp(g, 0)[1];
	...
	private static boolean areConnected(final int[] pred, final int u,
			final int v) {
