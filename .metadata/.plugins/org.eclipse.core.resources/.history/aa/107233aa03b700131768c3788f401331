...
import com.iliev.peter.kata.FlagSort27;
...
public class FlagSortTest {
	...
	{
		assertTrue(FlagSort27.getDigit(1, 1) == 1);
	}

	@Test
	public void test_002() throws Exception
	{
		assertTrue(FlagSort27.getDigit(1, 10) == 0);
	}

	@Test
	public void test_003() throws Exception
	{
		assertTrue(FlagSort27.getDigit(11, 10) == 1);
	}

	@Test
	public void test_004() throws Exception
	{
		assertTrue(FlagSort27.getDigit(777, 100) == 7);
	}

	@Test
	public void test_006() throws Exception
	{
		assertTrue(FlagSort27.getDigit(777, 1000) == 0);
	}

	@Test
	public void test_007() throws Exception
	{
		assertTrue(FlagSort27.getDigit(770, 1) == 0);
	}

	@Test(expected = IllegalArgumentException.class)
	public void test_008() throws Exception
	{
		FlagSort27.getMaxLength(null);
	}

	@Test
	public void test_009() throws Exception
	{
		assertTrue(FlagSort27.getMaxLength(new Integer[0]) == 0);
	}

	@Test
	public void test_0091() throws Exception
	{
		assertTrue(FlagSort27.getMaxLength(new Integer[] { 1 }) == 1);
	}
